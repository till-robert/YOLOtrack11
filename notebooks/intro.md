...
model = YOLOtrack11("yolo11n-zaxis.yaml") # load the model with scale 'n'
results = model.train(data="datasets/dataset.yaml", epochs=40) # train the model for 40 epochs
```
